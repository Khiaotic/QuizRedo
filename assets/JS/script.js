...
////in order to use event you have to have event
function selectAnswer(e) {
  ...
  /////if the current question is greater than 
  if (currentQuestionIndex >= questions.length -1) {
      return console.log('Game Over')
      ///////at game over => i want to hyperlink to scores.html ////////////
...
// function endGame
////local storage///scores///saves/////redirect/////
...
const questions = [
  {
    ...
    answers: [
      {
        text: "== compares the data type in value, while === compares the value and data type",
        correct: true,
      },
      {
        text: "== is a programming interface for HTML and XML documents",
        correct: false,
      },
  ...
  },
  {
    ...
    answers: [
      { text: "", correct: false },
      {
        text: "algorithm is not apart of the developing process",
        correct: false,
      },
      { text: "blah", correct: true },
      { text: "there are no differences between the two", correct: false },
    ],
  },
  {
